...
cliente1 = Cliente("João", 1990, "Masculino", 1000, "Rua A, 123")
cliente2 = Cliente("Maria", 1985, "Feminino", -500, "Rua B, 456")
cliente3 = Cliente("Pedro", 2000, "Masculino", 200, "Rua C, 789", ativo=False)
